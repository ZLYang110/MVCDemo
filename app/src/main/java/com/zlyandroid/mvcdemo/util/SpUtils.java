...
public class SpUtils {
    ...
    public static boolean SetConfigString(String keyanme, String keyvalue) {
        ...
        try
        {
            ...
            SharedPreferences mySharedPreferences= ProApplication.getContext().getSharedPreferences(spFileName, Activity.MODE_PRIVATE);
    ...
    public static String GetConfigString(String keyanme)
    {
        ...
        try
        {
            SharedPreferences sharedPreferences= ProApplication.getContext().getSharedPreferences(spFileName, Activity.MODE_PRIVATE);
     ...
     //       LogUtils.d(strout);
            //Toast.makeText(context, strout,Toast.LENGTH_LONG).show();
            ZLog.d("我没异常----我取数据"+keyanme+" -------"+resultvalue);
        }
        catch(Exception ex)
        {
            ZLog.d("我异常了");
    ...
    public static Boolean getBoolean(String strKey,
                                     Boolean strDefault) {
        SharedPreferences setPreferences = ProApplication.getContext().getSharedPreferences(
    ...
    public static void putBoolean( String strKey,
                                  Boolean strData) {
        SharedPreferences activityPreferences = ProApplication.getContext().getSharedPreferences(
                spFileName, Context.MODE_PRIVATE);
