...
import com.zlyandroid.mvcdemo.ui.LoginActivity;
...
public abstract class BaseObserver<T> implements Observer<BaseResponse<T>> {
    ...
    public void onNext(BaseResponse<T> tBaseEntity) {
        ...
        if (tBaseEntity.isSuccess()) {
            ...
            try {
                ZLog.d("3333333333333333333    "+tBaseEntity.getCode()+"   "+tBaseEntity.getMsg());
                if (tBaseEntity.getCode()==-1001){
                    ZLog.d("777777777777777777777777777");
                    startLogin();
...
//                    break;
    ...
    public  static  void startLogin(){
        Intent intent=new Intent(ProApplication.getContext(), LoginActivity.class);
        ProApplication.getContext().startActivity(intent);
    }
    @Override
